...
import 'package:whitefleet/views/bottom%20sheets/add_school_invoice.dart';
      ...
      children: [
        Container(
          ...
          child: ExpansionTile(
            ...
            children: [
              Obx(()=>
                 cont.schoolInvoiceData.value == null
                    ? LoadingWidget(height: SizeConfig.heightMultiplier * 10)
                    : cont.schoolInvoiceData.value!.isEmpty
                        ? NoDataWidget(text: 'No invoices for school')
                        : Column(
                            children: [
                              ...List.generate(
                                  cont.schoolInvoiceData.value!.length,
                                  (index) {
                                final data = cont
                                    .schoolInvoiceData.value![index];
                                return Padding(
              ...
              CustomButton(
                title: "Add New Task",
                onTap: () async => Get.bottomSheet(AddSchoolInvoiceBS(),
